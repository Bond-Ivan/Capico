...
},{"./burger.js":"5KBwH"}],"5KBwH":[function(require,module,exports,__globalThis) {
...
burger.addEventListener('click', ()=>{
    ...
    if (navMobileWrapper.classList.contains('header__nav-mobile__wrapper--active')) burger.style.position = 'fixed';
    else burger.style.position = '';
});
